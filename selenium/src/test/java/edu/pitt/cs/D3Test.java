...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.get("http://locaolhost:8080");
  ...
  public void tEST2RESET() {
    ...
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[1]")).getText(), is("ID 1. Jennyanydots"));
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[3]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  public void tEST3CATALOG() {
    ...
    {
      WebElement element = driver.findElement(By.xpath("(//li/img)[2]"));
  ...
  public void tEST4LISTING() {
    ...
    driver.findElement(By.xpath("//a[text()=\'Catalog\']")).click();
    {
      List<WebElement> elements = driver.findElements(By.id("cat-id4"));
      assert(elements.size() == 0);
    }
    vars.put("thirdCat", driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[3]")).getText());
  ...
  public void tEST6RENT() {
    ...
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[1]")).getText(), is("Rented out"));
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("(//li[@class=\'list-group-item\'])[3]")).getText(), is("ID 3. Mistoffelees"));
  ...
  public void dEFECT3FUNGREETACATWITHNAME() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=true\";document.cookie = \"3=false\";");
    assertThat(driver.findElement(By.id("greeting")).getText(), is("Old Deuteronomy is not here."));
  }
  @Test
  ...
  public void dEFECT1FUNFEED() {
    ...
    driver.findElement(By.id("catnips")).sendKeys("-6");
    driver.findElement(By.xpath("//button[text()=\'Feed\']")).click();
    // pause to wait instead of using wait for element visable command like in test 9
    try {
      Thread.sleep(3000);
